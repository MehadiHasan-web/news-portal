					...
					<div class="col-md-6 col-sm-4">
						 <div class="social">
                            <ul>
                                ...
                                <li><a href="{{ $social->youtube ?? '' ?? '' }}" target="_blank" class="instagram"> <i class="fa fa-youtube"></i></a></li>
                                <li><a href="{{ $social->instagram ?? '' ?? '' }}" target="_blank" class="android"> <i class="fa fa-instagram"></i></a></li>
