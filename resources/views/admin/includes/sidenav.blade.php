        ...
        <div class="nav">
            ...
            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav">
                    ...
                    <a class="nav-link" href="{{ route('subcategory.index') }}">Sub Categorie</a>
                </nav>
            </div>

            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#district" aria-expanded="false" aria-controls="district">
                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                Districts
                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
            </a>
            <div class="collapse" id="district" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link" href="{{ route('district.index') }}">District</a>
                    <a class="nav-link" href="{{ route('subdistrict.index') }}">Sub District</a>
                </nav>
            </div>
