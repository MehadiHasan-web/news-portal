    ...
    <div class=" mb-3 " style="max-width: 900px;">
        <div class="d-flex justify-content-end ">
                <div class="input-group mb-3 me-2 ">
                    <input id="search" name="search" style="height: 36px; margin-top: 4px;" type="text" class="form-control" name="query" placeholder="Ask me anything..." aria-label="Ask me anything..." aria-describedby="button-addon2">
