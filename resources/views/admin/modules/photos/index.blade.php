        ...
        <table id="datatablesSimple">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $photo->title }}</td>
                    <td>
                        <img src="{{ URL::to($photo->photo) }}" alt="{{ $photo->title }}"  style="width: 80px; height:70px;" alt="" class="border-rounded">
                    </td>
                    <td>
                        @if ($photo->type==1)
                    ...
                    <td >
                        <a href="{{ route('photo.edit', $photo->id) }}" class="btn btn-info btn-sm "><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel">Add New Phooto</h1>
